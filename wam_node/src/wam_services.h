...
public:
  explicit WamServices(systems::Wam<DOF> &wam, ProductManager &pm, Hand* hand, bool found_hand)
    ...
    joint_move_srv_ = create_service<wam_msgs::srv::JointMove>(
        "/wam/moveToJointPosition", joint_move_cb);
    cart_position_move_srv_ = create_service<wam_msgs::srv::CartPositionMove>(
        "/wam/moveToCartPosition", cart_position_move_cb);
    cart_orientation_move_srv_ = create_service<wam_msgs::srv::CartOrientationMove>(
        "/wam/moveToCartOrientation", cart_orientation_move_cb);
    cart_pose_move_srv_ = create_service<wam_msgs::srv::CartPoseMove>(
        "/wam/moveToCartPose", cart_pose_move_cb);
    set_velocity_limit_srv_ = create_service<wam_msgs::srv::VelocityLimit>(
