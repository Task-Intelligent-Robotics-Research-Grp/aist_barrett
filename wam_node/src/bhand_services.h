...
class BhandServices : public rclcpp::Node {
 ...
 public:
  explicit BhandServices(Hand& hand)
    ...
    // Create Services
    finger_position_srv_ = create_service<bhand_msgs::srv::FingerPosition>(
        "/bhand/moveToFingerPositions", finger_position_cb);
    grasp_position_srv_ = create_service<bhand_msgs::srv::GraspPosition>(
        "/bhand/moveToGraspPosition", grasp_position_cb);
    spread_position_srv_ = create_service<bhand_msgs::srv::SpreadPosition>(
        "/bhand/moveToSpreadPosition", spread_position_cb);
    finger_velocity_srv_ = create_service<bhand_msgs::srv::FingerVelocity>(
        "/bhand/moveToFingerVelocities", finger_velocity_cb);
    grasp_velocity_srv_ = create_service<bhand_msgs::srv::GraspVelocity>(
        "/bhand/moveToGraspVelocity", grasp_velocity_cb);
    spread_velocity_srv_ = create_service<bhand_msgs::srv::SpreadVelocity>(
