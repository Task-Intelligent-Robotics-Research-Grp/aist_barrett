...
class WamSubscribers : public rclcpp::Node
{
  ...
  public:
    ...
    explicit
    WamSubscribers(systems::Wam<DOF>& wam, ProductManager& pm)
        :Node("WamSubscribers"),
         wam_(wam),
         pm_(pm),
        ...
        rt_cart_position_sub_
            = this->create_subscription<wam_msgs::msg::RTCartPosition>(
                ...
                std::bind(&WamSubscribers::rtCartPositionCb,
                          this, std::placeholders::_1));
        rt_cart_pose_sub_
            = this->create_subscription<wam_msgs::msg::RTCartPose>(
...
WamSubscribers<DOF>::rtJointPositionCb(
...
template <size_t DOF> void
WamSubscribers<DOF>::rtAngularVelocityCb(
...
template <size_t DOF> void
WamSubscribers<DOF>::rtLinearVelocityCb(
...
template <size_t DOF> void
WamSubscribers<DOF>::rtCartPositionCb(
    const wam_msgs::msg::RTCartPosition::SharedPtr msg)
{
    if (!rt_cart_position_status_)
    {
      ...
      //set the value of rate limiter to subscribed rate limits, and limit goal CP by that.
        ...
        systems::forceConnect(cp_cmd_track_.output,
...
template <size_t DOF> void
WamSubscribers<DOF>::rtCartPoseCb(
...
template <size_t DOF> void
WamSubscribers<DOF>::rtCartOrientationCb(
...
template <size_t DOF> void
WamSubscribers<DOF>::rtJointVelocityCb(
...
WamSubscribers<DOF>::startLogging()
{
    ...
    systems::forceConnect(joint_rate_limiter_.output,
